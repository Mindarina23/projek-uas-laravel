                ...
                <table class="min-w-full table-auto">
                    ...
                    @forelse($barangs as $barang)
                        <tr class="border bg-white">
                            ...
                            <td class="px-16 py-2">{{ $barang->nama_barang }}</td>
                            <td class="px-16 py-2">{{ $barang->satuan }}</td>
                            <td class="px-16 py-2">{{ $barang->harga_formatted }}</td>

                            <!--action untuk tombol hapus dan edit belum ditambahkan -->
                            <td class="px-10 py-2 text-center">
                                <a href="{{ route('admin.barang.edit', $barang->id_barang) }}" class="bg-indigo-600 px-4 py-2 rounded shadow-sm text-xs text-white focus:outline-none">EDIT</a>

                                <button onClick="destroy(this.id)" id="{{ $barang->id_barang }}" class="bg-red-600 px-4 py-2 rounded shadow-sm text-xs text-white focus:outline-none">HAPUS</button>
                            </td>
                        </tr>
                    @empty
